...
local legacyPanelName = player:getName()
if not SuppliesConfig[panelName] and SuppliesConfig[legacyPanelName] then
  SuppliesConfig[panelName] = SuppliesConfig[legacyPanelName]
  SuppliesConfig[legacyPanelName] = nil
end
